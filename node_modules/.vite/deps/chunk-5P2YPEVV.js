  ...
  "node_modules/@mediapipe/pose/pose.js"(exports) {
    (function() {
      ...
      J("Promise", function(a) {
        ...
        b.race = function(e) {
          return new b(function(h, k) {
            for (var l = M(e), n = l.next(); !n.done; n = l.next())
              d(n.value).J(h, k);
          });
        };
        b.all = function(e) {
      ...
      function Xa(a, b, c) {
        ...
        c = g - a.g.g;
        if (0 !== c)
          throw Error("Message parsing ended unexpectedly. Expected to read " + f + " bytes, instead read " + (f - c) + " bytes, either the data ended unexpectedly or the message misreported its own length");
        a.g.g = g;
        a.g.i = d;
        return b;
      }
      function Ya(a) {
        ...
        if (Ba)
          ...
          b = c + b;
          for (var f = [], g = null, e, h, k; c < b; )
            e = a[c++], 128 > e ? f.push(e) : 224 > e ? c >= b ? f.push(65533) : (h = a[c++], 194 > e || 128 !== (h & 192) ? (c--, f.push(65533)) : f.push((e & 31) << 6 | h & 63)) : 240 > e ? c >= b - 1 ? f.push(65533) : (h = a[c++], 128 !== (h & 192) || 224 === e && 160 > h || 237 === e && 160 <= h || 128 !== ((d = a[c++]) & 192) ? (c--, f.push(65533)) : f.push((e & 15) << 12 | (h & 63) << 6 | d & 63)) : 244 >= e ? c >= b - 2 ? f.push(65533) : (h = a[c++], 128 !== (h & 192) || 0 !== (e << 28) + (h - 144) >> 30 || 128 !== ((d = a[c++]) & 192) || 128 !== ((k = a[c++]) & 192) ? (c--, f.push(65533)) : (e = (e & 7) << 18 | (h & 63) << 12 | (d & 63) << 6 | k & 63, e -= 65536, f.push((e >> 10 & 1023) + 55296, (e & 1023) + 56320))) : f.push(65533), 8192 <= f.length && (g = za(g, f), f.length = 0);
          d = za(g, f);
        }
        return d;
      }
          ...
          return O(c, function(m) {
            switch (m.g) {
              ...
              case 2:
                e = m.h;
                if ("object" === typeof window)
                  return Lb("createMediapipeSolutionsWasm", { locateFile: d.locateFile }), Lb("createMediapipeSolutionsPackedAssets", { locateFile: d.locateFile }), l = g.filter(function(u) {
        ...
        return Z(a, function c() {
          ...
          return O(c, function(w) {
            ...
            for (e = g.next(); !e.done; e = g.next())
              h = e.value, d.i.overrideFile(h, d.B[h]);
            d.B = {};
            if (d.g.listeners)
                        ...
                        case "detections":
                          ...
                          for (x = 0; x < u.length; ++x) {
                            ...
                            if (null != C && null != C) {
                              ...
                              C = Q;
                              for (q = R; 0 < q || 127 < C; )
                                r.push(C & 127 | 128), C = (C >>> 7 | q << 25) >>> 0, q >>>= 7;
                              r.push(C);
                            }
                            qb(p, A);
                            I = ab(I);
          ...
          return O(f, function(F) {
            switch (F.g) {
              case 1:
                ...
                h = M(Object.keys(c));
                for (k = h.next(); !k.done; k = h.next())
                  l = k.value, n = c[l], "string" !== typeof n && "texture" === n.type && void 0 !== b[n.stream] && ++e;
                1 < e && (v.G = false);
                w = M(Object.keys(c));
                k = w.next();
              case 2:
                ...
                y = c[t];
                if ("string" === typeof y)
                  return z = g, E = t, N(F, Wb(v, t, b[y]), 14);
                m = b[y.stream];
                        ...
                        for (r = new Ua(r); Va(r); )
                          switch (r.i) {
                            ...
                            case 45:
                              ...
                              break;
                            case 48:
                              for (var H = r.g, L = 128, Ja = 0, aa = q = 0; 4 > aa && 128 <= L; aa++)
                                L = H.h[H.g++], Ja |= (L & 127) << 7 * aa;
                              128 <= L && (L = H.h[H.g++], Ja |= (L & 127) << 28, q |= (L & 127) >> 4);
                              if (128 <= L)
                                for (aa = 0; 5 > aa && 128 <= L; aa++)
                                  L = H.h[H.g++], q |= (L & 127) << 7 * aa + 3;
                              if (128 > L) {
                                H = Ja >>> 0;
                                L = q >>> 0;
                                if (q = L & 2147483648)
                                  H = ~H + 1 >>> 0, L = ~L >>> 0, 0 == H && (L = L + 1 >>> 0);
                                H = 4294967296 * L + (H >>> 0);
                                q = q ? -H : H;
                              } else
                                H.l = true, q = void 0;
      ...
      function Tb(a, b) {
        for (var c = b.name || "$", d = [].concat(fa(b.wants)), f = new a.h.StringList(), g = M(b.wants), e = g.next(); !e.done; e = g.next())
          f.push_back(e.value);
          ...
          modelComplexity: { type: 1, graphOptionXref: { calculatorType: "ConstantSidePacketCalculator", calculatorName: "ConstantSidePacketCalculatorModelComplexity", fieldName: "int_value" }, onChange: function(c) {
            return Z(b, function f() {
              ...
              return O(f, function(l) {
                if (1 == l.g)
                  return g = Xb(c), e = "third_party/mediapipe/modules/pose_landmark/" + g, N(l, Rb(h.g, g), 2);
                k = l.h;
...
//# sourceMappingURL=chunk-5P2YPEVV.js.map
