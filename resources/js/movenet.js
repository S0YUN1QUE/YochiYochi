...
export default class MoveNet{ 
  ...
  async init (cb){
    ...
    await posedetection.createDetector(posedetection.SupportedModels.MoveNet, 'lightning');
...
this.rafId = requestAnimationFrame(()=>this.renderPrediction(camera1, detector1, coordArr1,cb));
};
